...
class Config:
    ...
    INFER_IMAGE_DIR  = "/mnt/data/Anusha/Trajectory_13"
    INFER_MASK_DIR   = "/mnt/data/Anusha/UNET_SoftMax/Data_seg/VAL/TC/masks"
    INFER_OUTPUT_DIR = "/mnt/data/Anusha/UNET_SoftMax/try"
    INFER_ANNOTATION_DIR = Path("/mnt/data/Anusha/UNET_SoftMax/RESULTS_UNET_V2/results_pp_with_annotations/TC/json")
