...
class Config:
    ...
    # ==============================
    IMAGE_DIRS = [
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TC/images",
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TT/images",
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TV/images",
    ]
    MASK_DIRS = [
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TC/masks",
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TT/masks",
        "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/TV/masks",
    ]
    IMAGE_EXT = ".png"
    ...
    # INFERENCE
    # ==============================
    INFER_CHECKPOINT = "/mnt/data/Anusha/UNET_SoftMax/checkpoints_multihead_struct/best_model.pth"
    INFER_CHECKPOINT_VANILLA = "/mnt/data/Anusha/UNET/checkpoints_24struct/best_model.pth"
    INFER_CHECKPOINT_DUALHEAD = "/mnt/data/Anusha/UNET_SoftMax/checkpoints_multihead_struct/best_model.pth"
    INFER_IMAGE_DIR  = "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/VAL/TC/images"
    INFER_MASK_DIR   = "/mnt/data/Anusha/UNET_SoftMax/Data_Seg_struct/VAL/TC/masks"
    INFER_OUTPUT_DIR = "/mnt/data/Anusha/UNET_SoftMax/Results_leaderboard/TC1"
    INFER_ANNOTATION_DIR = Path("/mnt/data/Anusha/UNET_SoftMax/RESULTS_UNET_V2/results_pp_with_annotations/TV/json")
    ...
    # PATHS
    # ==============================
    CHECKPOINT_DIR = "./checkpoints_multihead_struct"
    LOG_DIR        = "./logs"
    BEST_MODEL     = "./checkpoints_multihead_struct/best_model.pth"
