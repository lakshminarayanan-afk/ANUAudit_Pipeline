...
class Config:
    ...
    INFER_CHECKPOINT = r"C:\mervin\Academics\intenship\HTIC\Mervin\mask_unet_bpd\best_model.pth" 
    
    # Path to the folder containing the images you want to process
    INFER_IMAGE_DIR  = r"C:\mervin\Academics\intenship\HTIC\Mervin\Dataset\Proper_data_BPD"
...
class Config:
    ...
    LOG_DIR        = "./logs"
    BEST_MODEL     = r"C:\mervin\Academics\intenship\HTIC\Mervin\mask_unet_bpd\best_model.pth"
    ...
    # Add these indices for the BPD algorithm
    MIDLINE_FALX_IDX = 3   # Index 3 in the Softmax head (Background=0, hem1=1, hem2=2, midline=3)
    CALV_INNER_CH    = 0   # Channel 0 of the Sigmoid head
    CALV_OUTER_CH    = 1   # Channel 1 of the Sigmoid head
